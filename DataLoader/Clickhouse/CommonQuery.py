...
def listTables():
    ...
    # 'cic_stats' table has shape of (11351327320 × 360), namely 11351327320 records on 360 properties of CIC collected data. (Updated on 22.07.2024)
    return f'''
    SHOW TABLES
    '''
